                        ...
                        <div class="header__nav">
                            <nav class="header__menu mobile-menu">
                                ...
                                <form  method="POST" action="{{ route('anime.search.shows') }}" class="form-inline my-2 my-lg-0">
                                    @csrf
                                    <input class="form-control mr-sm-2" type="search" name="show" placeholder="Search" aria-label="Search" style="margin-top: -84px; margin-left: 537px;">
                                </form>
                            </nav>
                        </div>
                    </div>
                            ...
                            <ul>
                                @guest
                                    ...
                                    @if (Route::has('login'))
                                        <li class="">
                                             <!-- here style-->
                                            <a style="margin-right: 100px;" class="" href="{{ route('login') }}">{{ __('Login') }}</a>
                                        </li>
                                    @endif
                                 ...
                                 @else
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                            <a class="dropdown-item  text-black" href="{{ route('users.followed.shows') }}"
                                            >
                                                Your Followed Shows
                                            </a>
